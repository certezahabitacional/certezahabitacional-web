...
const accionesDirector: AccionSistema[] = [
  ...
  "PAQUETE_GESTIONAR","CLIENTE_EDITAR_ADMIN","INMUEBLE_CREAR",
...
export const MATRIZ_PERMISOS: MatrizPermisos = {
  ...
  // VENDEDOR: consulta comercial y de expediente en modo lectura.
  ...
  [RolUsuario.ADMINISTRADOR]: new Set<AccionSistema>([
    ...
    "COTIZACION_DESCARGAR","COTIZACION_ENVIAR","PAQUETE_GESTIONAR",
...
export function puedeCrearUsuario(actor: RolUsuario, objetivo: RolUsuario): boolean {
  if (objetivo === RolUsuario.CLIENTE) return false;
