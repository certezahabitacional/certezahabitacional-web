CREATE OR REPLACE FUNCTION public.validar_confirmacion_proyecto_v1()
RETURNS trigger
LANGUAGE plpgsql
...
BEGIN
  IF NEW."proyectoConfirmado" = true AND COALESCE(OLD."proyectoConfirmado", false) = false THEN
...
DROP TRIGGER IF EXISTS trg_validar_confirmacion_proyecto_v1 ON public."InspeccionControlV2";
CREATE TRIGGER trg_validar_confirmacion_proyecto_v1
BEFORE UPDATE OF "proyectoConfirmado" ON public."InspeccionControlV2"
FOR EACH ROW
EXECUTE FUNCTION public.validar_confirmacion_proyecto_v1();
