...
export default async function ExpedientePage({
  ...
  const firmasInspector =
    inspeccion.firmas.some(
      (firma) =>
        firma.tipo
          .toLowerCase()
          .includes("inspector"),
    ...
    ...inspeccion.firmas
      ...
      .map((firma) => ({
        ...
        titulo:
          "Firma registrada",
        detalle:
          `${firma.tipo}: ${firma.nombreFirmante}`,
      })),
              ...
              >
                ...
                <label className="block text-sm font-bold text-slate-300">
                  ...
                  >
                    ...
                    <option value="REPORTE_PENDIENTE">
                      Reporte pendiente
                    </option>
          ...
          <div className="space-y-7">
            <section className="rounded-3xl border border-white/10 bg-slate-900 p-6">
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                ...
                <Dato
                  ...
                  valor={
                    inspeccion.superficieM2
                      ? `${Number(inspeccion.superficieM2)} m²`
                      : "No registrada"
                  }
                />
                ...
                <Dato
                  etiqueta="Dirección"
                  valor={`${inspeccion.direccion}, ${inspeccion.ciudad}`}
                />
              ...
              <div className="mt-5 space-y-4">
                {actividad.map(
                  (
                    ...
                    <div
                      key={`${evento.titulo}-${evento.fecha.toISOString()}-${index}`}
...
function Estado({
  ...
  return (
    <span
      className={`rounded-full px-3 py-1 text-xs font-black ${clase}`}
    >
      {estado.replaceAll(
        "_",
        " ",
